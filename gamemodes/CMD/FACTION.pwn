...
CMD:factionhelp(playerid)
{
	if(pData[playerid][pFaction] == 1)
	{
		...
		Dialog_Show(playerid, UnusedScreen, DIALOG_STYLE_MSGBOX, ""RED_E"SAPD", str, "Close", "");
	}
	else if(pData[playerid][pFaction] == 2)
	{
		...
		strcat(str, ""WHITE_E"NOTE: Lama waktu duty anda akan menjadi gaji anda pada saat paycheck!\n");
		Dialog_Show(playerid, UnusedScreen, DIALOG_STYLE_MSGBOX, ""RED_E"SAGS", str, "Close", "");
	}
	else if(pData[playerid][pFaction] == 3)
	{
		...
		strcat(str, ""WHITE_E"NOTE: Lama waktu duty anda akan menjadi gaji anda pada saat paycheck!\n");
		Dialog_Show(playerid, UnusedScreen, DIALOG_STYLE_MSGBOX, ""RED_E"SAMD", str, "Close", "");
	}
	else if(pData[playerid][pFaction] == 4)
	{
		...
		strcat(str, ""WHITE_E"NOTE: Lama waktu duty anda akan menjadi gaji anda pada saat paycheck!\n");
		Dialog_Show(playerid, UnusedScreen, DIALOG_STYLE_MSGBOX, ""RED_E"SANA", str, "Close", "");
	}
	else if(pData[playerid][pFamily] != -1)
	{
		new str[3500];
		strcat(str, ""WHITE_E"Family: /fsave /f(amily) /finvite /funinvite /fsetrank\n");
		Dialog_Show(playerid, UnusedScreen, DIALOG_STYLE_MSGBOX, ""RED_E"Family", str, "Close", "");
	}
	else
	{
...
CMD:locker(playerid, params[])
{
	...
	foreach(new lid : Lockers)
	{
		if(IsPlayerInRangeOfPoint(playerid, 2.5, lData[lid][lPosX], lData[lid][lPosY], lData[lid][lPosZ]))
		{
			...
			{
				Dialog_Show(playerid, LockerVIP, DIALOG_STYLE_LIST, "VIP Locker", "Health\nWeapons\nClothing\nVip Toys", "Okay", "Cancel");
			}
			...
			{
				Dialog_Show(playerid, LockerSANEW, DIALOG_STYLE_LIST, "SANA Lockers", "Toggle Duty\nHealth\nArmour\nWeapons\nClothing", "Proceed", "Cancel");
			}
...
CMD:sapdonline(playerid, params[])
{
	...
	format(lstr, sizeof(lstr), "%s\n", lstr);
	Dialog_Show(playerid, UnusedScreen, DIALOG_STYLE_TABLIST_HEADERS, "SAPD Online", lstr, "Close", "");
	return 1;
}
...
CMD:sagsonline(playerid, params[])
{
	...
	format(lstr, sizeof(lstr), "%s\n", lstr);
	Dialog_Show(playerid, UnusedScreen, DIALOG_STYLE_TABLIST_HEADERS, "SAGS Online", lstr, "Close", "");
	return 1;
}
...
CMD:samdonline(playerid, params[])
{
	...
	format(lstr, sizeof(lstr), "%s\n", lstr);
	Dialog_Show(playerid, UnusedScreen, DIALOG_STYLE_TABLIST_HEADERS, "SAMD Online", lstr, "Close", "");
	return 1;
}
...
CMD:sanaonline(playerid, params[])
{
	...
	format(lstr, sizeof(lstr), "%s\n", lstr);
	Dialog_Show(playerid, UnusedScreen, DIALOG_STYLE_TABLIST_HEADERS, "SANA Online", lstr, "Close", "");
	return 1;
}
