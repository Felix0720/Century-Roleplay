CMD:acmds(playerid)
{
	...
	Dialog_Show(playerid, UnusedScreen, DIALOG_STYLE_MSGBOX, ""ORANGE_E"SoI:RP: "YELLOW_E"Staff Commands", line3, "OK","");
	return true;
}
...
CMD:admins(playerid, params[])
{
	...
	if(pData[playerid][pAdmin] > 0)
	{
		...
		if(count > 0)
		{
			Dialog_Show(playerid, UnusedScreen, DIALOG_STYLE_MSGBOX, ""RED_E"Staff Online", line3, "Close", "");
		}
		else return Dialog_Show(playerid, UnusedScreen, DIALOG_STYLE_MSGBOX, ""RED_E"Staff Online", "There are no admin online!", "Close", "");
	}
	else
	{
		foreach(new i:Player)
		...
		else return Dialog_Show(playerid, UnusedScreen, DIALOG_STYLE_MSGBOX, ""RED_E"Staff Online", "There are no admin online duty!", "Close", "");
	}
	return 1;
}
...
CMD:adminjail(playerid, params[])
{
	...
	if(count > 0)
	{
		Dialog_Show(playerid, UnusedScreen, DIALOG_STYLE_MSGBOX, ""RED_E"Jail Player", line3, "Close", "");
	}
	else
	{
		Dialog_Show(playerid, UnusedScreen, DIALOG_STYLE_MSGBOX, ""RED_E"Jail Player", "There are no player in jail!", "Close", "");
	}
	return 1;
}
...
CMD:vmodels(playerid, params[])
{
    ...
    Dialog_Show(playerid, UnusedScreen, DIALOG_STYLE_LIST, "Vehicle Models", string, "Close", "");
    return 1;
}
