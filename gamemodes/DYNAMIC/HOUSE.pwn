...
House_WeaponStorage(playerid, houseid)
{
    ...
    Dialog_Show(playerid, HouseWeapon, DIALOG_STYLE_LIST, "Weapon Storage", string, "Select", "Cancel");
    return 1;
}
...
House_Refresh(houseid)
{
    if(houseid != -1)
    {
		...
		{
			format(string, sizeof(string), ""WHITE_E"--===["LB2_E"House Info"WHITE_E"]===--\n"WHITE_E"ID: %d\n"WHITE_E"House Type: "BLUE_E"%s\n"WHITE_E"House Location: "ORANGE_E"%s\n"WHITE_E"Owned By: "YELLOW_E"%s\n"WHITE_E"--===["LB2_E"House Info"WHITE_E"]===--", houseid, type, GetLocation(hData[houseid][hExtposX], hData[houseid][hExtposY], hData[houseid][hExtposZ]), hData[houseid][hOwner], type);
        ...
        {
        	format(string, sizeof(string), ""WHITE_E"--===["RED_E"For Sale"WHITE_E"]===--\n"WHITE_E"ID: %d\n"WHITE_E"House Type: "BLUE_E"%s\n"WHITE_E"House Location: "ORANGE_E"%s\n"WHITE_E"House Price: "GREEN_E"%s\n"YELLOW_E"Type /buy to purchase\n"WHITE_E"--===["RED_E"For Sale"WHITE_E"]===--", houseid, type, GetLocation(hData[houseid][hExtposX], hData[houseid][hExtposY], hData[houseid][hExtposZ]), FormatMoney(hData[houseid][hPrice]));
            hData[houseid][hPickup] = CreateDynamicPickup(1273, 23, hData[houseid][hExtposX], hData[houseid][hExtposY], hData[houseid][hExtposZ]+0.2, 0, 0, _, 10.0);
        }
        ...
        hData[houseid][hLabel] = CreateDynamic3DTextLabel(string, COLOR_GREEN, hData[houseid][hExtposX], hData[houseid][hExtposY], hData[houseid][hExtposZ]+0.2, 2.5, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 1, 0, 0);
    }
    return 1;
}
...
CMD:sellhouse(playerid, params[])
{
	...
	Dialog_Show(playerid, SellHouses, DIALOG_STYLE_LIST, "Sell Houses", CMDSString, "Sell", "Cancel");
	return 1;
}
...
CMD:myhouse(playerid)
{
	...
	Dialog_Show(playerid, MyHouse, DIALOG_STYLE_LIST, "{FF0000}SoI:RP: {0000FF}Houses", CMDSString, "Select", "Cancel");
	return 1;
}
