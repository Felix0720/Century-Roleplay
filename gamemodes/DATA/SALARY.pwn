...
DisplaySalary(playerid)
{
	...
	if(rows) 
	{
		...
		Dialog_Show(playerid, UnusedScreen, DIALOG_STYLE_TABLIST_HEADERS, title, list, "Close", "");
	}
	else
	{
...
DisplayPaycheck(playerid)
{
	...
	if(rows) 
	{
		...
		Dialog_Show(playerid, PayCheckScreen, DIALOG_STYLE_TABLIST_HEADERS, title, list, "Get", "Close");
	}
	else
	{
