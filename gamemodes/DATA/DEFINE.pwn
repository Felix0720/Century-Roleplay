// Server Define
#define TEXT_GAMEMODE	"BETA version 7"
#define TEXT_WEBURL		"www.lstarcommunity.com"
...
#define LOOPTD(%0, %1, %2) for(new %1 = %0; %1 < %2; %1++)
//#define LoopTD(%1, %2) for(new %1; %1 < %2; %1++)
