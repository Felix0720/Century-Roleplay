...
/*CMD:deletepv(playerid, params[])
{
	...
	if(found)
		Dialog_Show(playerid, DIALOG_DELETEVEH, DIALOG_STYLE_TABLIST_HEADERS, "Delete Vehicles", msg2, "Delete", "Close");
	else
		Dialog_Show(playerid, UnusedScreen, DIALOG_STYLE_MSGBOX, "Vehicles", "Player ini tidak memeliki kendaraan", "Close", "");
...
CMD:gotopv(playerid, params[])
{
	...
	if(found)
		Dialog_Show(playerid, DIALOG_GOTOVEH, DIALOG_STYLE_TABLIST_HEADERS, "Goto Vehicles", msg2, "Goto", "Close");
	else
		Dialog_Show(playerid, UnusedScreen, DIALOG_STYLE_MSGBOX, "Vehicles", "Player ini tidak memeliki kendaraan", "Close", "");
...
CMD:getpv(playerid, params[])
{
	...
	if(found)
		Dialog_Show(playerid, DIALOG_GETVEH, DIALOG_STYLE_TABLIST_HEADERS, "Get Vehicles", msg2, "Get", "Close");
	else
		Dialog_Show(playerid, UnusedScreen, DIALOG_STYLE_MSGBOX, "Vehicles", "Player ini tidak memeliki kendaraan", "Close", "");
...
CMD:ainsu(playerid, params[])
{
	...
	if(found)
		Dialog_Show(playerid, UnusedScreen, DIALOG_STYLE_TABLIST_HEADERS, "Insurance Vehicles", msg2, "Close", "");
	else
		Dialog_Show(playerid, UnusedScreen, DIALOG_STYLE_MSGBOX, "Vehicles", "Player tidak memeliki kendaraan", "Close", "");
	return 1;
}
...
CMD:apv(playerid, params[])
{
	...
	if(found)
		Dialog_Show(playerid, UnusedScreen, DIALOG_STYLE_TABLIST_HEADERS, "Player Vehicles", msg2, "Close", "");
	else
		Dialog_Show(playerid, UnusedScreen, DIALOG_STYLE_MSGBOX, "Vehicles", "Player ini tidak memeliki kendaraan", "Close", "");
	...
	if(found)
		Dialog_Show(playerid, UnusedScreen, DIALOG_STYLE_TABLIST_HEADERS, "Vehicles Plate", msg2, "Close", "");
	else
...
CMD:v(playerid, params[])
{
	...
	else if(!strcmp(type,"my",true))
	{
		...
		if(found)
			Dialog_Show(playerid, FindVeh, DIALOG_STYLE_TABLIST_HEADERS, "My Vehicles", msg2, "Find", "Close");
		else
			Dialog_Show(playerid, UnusedScreen, DIALOG_STYLE_MSGBOX, "Vehicles", "Anda tidak memeliki kendaraan", "Close", "");
	}
	else if(!strcmp(type,"insu",true))
	{
		...
		if(found)
			Dialog_Show(playerid, UnusedScreen, DIALOG_STYLE_TABLIST_HEADERS, "My Vehicles", msg2, "Close", "");
		else
			Dialog_Show(playerid, UnusedScreen, DIALOG_STYLE_MSGBOX, "Vehicles", "Anda tidak memeliki kendaraan", "Close", "");
	}
